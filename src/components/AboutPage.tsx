  ...
  return (
    <div className="min-h-screen px-6 py-8 pb-28">
      <div className="max-w-md mx-auto">
        ...
        {/* Hero Image */}
        <div className="mb-8">
          <div className="w-full h-48 bg-gradient-to-br from-orange-100 to-pink-100 rounded-2xl shadow-lg flex items-center justify-center">
            <div className="text-center">
              <div className="text-6xl mb-2">👨‍👩‍👧‍👦</div>
              <p className="text-gray-600">Family using technology together</p>
            </div>
          </div>
        </div>
